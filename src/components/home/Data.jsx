...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Naushad Alam
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm a recent graduate Software Engineer based in India, and I'm very passionate and dedicated to learn new skills & Technology.</p>
